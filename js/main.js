const contentText = {
    ...
    projects: {
        ...
        body: `
            ...
            <p class="lead"><a class="work-link" href="https://codepen.io/ChrisChafin/full/weLwjg/" target="_blank">Utilizing the Twitch JSON API</a> - Fetching data from the Twitch API and stylizing it</p>
            `
    }
}
$(document).ready(() => {
